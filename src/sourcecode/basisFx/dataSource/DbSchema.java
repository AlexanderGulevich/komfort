...
//                " where r.employerId=e.id  "+
        ...
        String viewSalaryByMonth= "Create  view SalaryByMonth  as " +
                "SELECT * FROM (SELECT SUM(SALARY) AS SALARY, EMPLOYERID,  MONTH(\"DATE\") AS monthForSalary\n" +
                "  FROM TIMERECORDINGANDSALARY\n" +
                " GROUP BY MONTH(DATE), EMPLOYERID) AS salary\n" +
                " LEFT JOIN Employer ON Employer.id=salary.EMPLOYERID";
        String viewSalaryByYear=  "Create  view SalaryByYear  as " +"SELECT * FROM (\n" +
                "SELECT SUM(SALARY) AS SALARY, EMPLOYERID,  Year(DATE) AS yearForSalary\n" +
                "  FROM TIMERECORDINGANDSALARY\n" +
