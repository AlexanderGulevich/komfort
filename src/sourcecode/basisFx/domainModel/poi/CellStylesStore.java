...
//                new CellStylePOIAdapter(workbook, spreadsheet)
//                          .setFontHeight(12)
//                          .setFontColor(IndexedColors.GREY_80_PERCENT.index)
...
//                new CellStylePOIAdapter(workbook, spreadsheet)
//                            .setFontHeight(11)
//                            .setFontColor(IndexedColors.BLACK.index)                           
//                            .setFontBold()
//                            .setWrapText()
...
//                         .setFontName("Calibri")
//                         .setFontBold()
//                         .setFontColor(IndexedColors.ORANGE.index)
...
//                         .setFontBold()
//                         .setWrapText()
//                         .setFontColor(IndexedColors.TEAL.index)
//                         .setFillForegroundColRGB(255,222,173)
//                         .setFillPattern(FillPatternType.SOLID_FOREGROUND)
//                         .setBorder(BorderStyle.THIN, 
//                                    BorderStyle.THIN,
