...
public class WindowUndecorated extends WindowFx{
    ...
    public WindowUndecorated setContentLayer(double t,double r,double b,double l) {
        ...
        LayersRegistry.setContentLayer(contentLauer);
    ...
    public WindowUndecorated createMainMenu(CSSID css,AnchorPane ap,AnchorCoordinate c, MenuRepresent r){
         new MainMenu( css, ap, c,r);
         return this;
     }
