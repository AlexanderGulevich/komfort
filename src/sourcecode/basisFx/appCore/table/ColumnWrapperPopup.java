...
//
//    private ColumnWrapperPopup(Builder builder) {
...
//
//        Callback<TableColumn<ActiveRecord, LocalDate>, TableCell<ActiveRecord, ActiveRecord>> dateCellFactory
//                = (TableColumn<ActiveRecord, ActiveRecord> param) -> new DateEditingCell();
//
...
//        }
//
//        public ColumnWrapperPopup build() {
//            return new ColumnWrapperPopup(this);
//        }
//    }
//
//
//
//    class DateEditingCell extends TableCell<ActiveRecord, ActiveRecord> {
//
